...
onMounted(() => {
  axios.get("https://mock.apifox.com/m1/2893111-0-default/emps").then((res) => {
      ...
      <el-container>
          ...
          <el-scrollbar>
            <el-menu :default-openeds="['1', '3']">
              ...
              <el-sub-menu index="2">
                ...
                <el-menu-item-group>
                  <template #title></template>
                  <el-menu-item index="2-1"><router-link to="/dept">部门管理</router-link></el-menu-item>
                  <el-menu-item index="2-2"><router-link to="/emp">员工管理</router-link></el-menu-item>
                </el-menu-item-group>
              </el-sub-menu>
              <el-sub-menu index="3">
                <template #title>
        ...
        <el-main>
          ...
          >
            ...
            <el-table-column property="image" label="图像" show-overflow-tooltip>
              <template #default="scope">
                <img :src="scope.row.image" style="width: 20px;">
              </template>
            </el-table-column>
            ...
            <el-table-column property="age" label="年龄" show-overflow-tooltip/>
            <!--            <el-table-column property="lastOpratorTime" label="最后操作时间" show-overflow-tooltip/>-->
